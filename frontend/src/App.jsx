...
function renderOperatorLockedBanner(message) {
  if (operatorUnlocked) return null;

  return (
    <div className="operator-locked-banner">
      {message}
    </div>
  );
}
        ...
        <div className={`simple-square ${expandedSimpleQuadrant ? "simple-has-expanded" : ""}`}>
          ...
          <section className={getSimpleQuadrantClass("controls", "simple-quadrant simple-q-controls")}>
            ...
            <div className="simple-quadrant-body">
              ...
              {renderOperatorLockedBanner("PUBLIC READ-ONLY MODE — UNLOCK OPERATOR MODE TO OPTIMIZE OR RUN THE AGENT.")}
              ...
              <details className="simple-control-drawer">
                ...
                {renderOperatorLockedBanner("SETUP LOCKED — ASSET, STRATEGY, MODE, SIZE, AND INTERVAL NEED OPERATOR PASSWORD.")}

                <div className="simple-control-grid simple-terminal-controls">
                  <div>
                    <label>ASSET</label>
                    <select value={coin} disabled={isOperatorControlLocked()} title={getOperatorLockTitle("CHANGE AGENT SETUP")} onChange={(e) => handleManualSetupChange({ coin: e.target.value }, true)} onWheel={(e) => e.currentTarget.blur()}>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      title={getOperatorLockTitle("CHANGE AGENT SETUP")}
                      onChange={(e) => {
                  ...
                  <div>
                    ...
                    <input type="number" min="0" step="0.001" value={tradeSize} disabled={isOperatorControlLocked()} title={getOperatorLockTitle("CHANGE AGENT SETUP")} onChange={(e) => handleManualSetupChange({ trade_size: Number(e.target.value) }, false)} />
                  </div>
                </div>
              </details>
          ...
          <div className="retro-quadrant-body">
            ...
            <details className="retro-window">
              ...
              <div className="metrics autonomous-section detailed-portfolio-panel">
                ...
                <button onClick={resetPnlBaseline} disabled={isOperatorControlLocked()} title={getOperatorLockTitle("RESET PORTFOLIO BASELINE")} className="copy-btn" style={{ marginTop: "12px", ...getButtonStyle("resetPnl") }}>
            ...
            <details className="retro-window">
              ...
              <div className="input-row">
                ...
                <div>
                  ...
                  <select value={timeframe} disabled={isOperatorControlLocked()} title={getOperatorLockTitle("CHANGE AGENT SETUP")} onChange={(e) => handleManualSetupChange({ timeframe: e.target.value }, true)} onWheel={(e) => e.currentTarget.blur()}>
                ...
                <div>
                  ...
                  <select value={risk} disabled={isOperatorControlLocked()} title={getOperatorLockTitle("CHANGE AGENT SETUP")} onChange={(e) => handleManualSetupChange({ risk: e.target.value }, true)} onWheel={(e) => e.currentTarget.blur()}>
                ...
                <div>
                  ...
                  <div className="capital-input">
                    <span>$</span>
                    <input type="number" min="100" step="100" value={initialCapital} disabled={isOperatorControlLocked()} title={getOperatorLockTitle("CHANGE AGENT SETUP")} onChange={(e) => handleManualSetupChange({ initial_capital: Number(e.target.value) }, true)} />
                  </div>
                </div>
        ...
        <main className="ikqf-full-v2-terminal">
          ...
          <section className="ikqf-full-v2-panel">
            ...
            <div className="ikqf-full-v2-button-grid ikqf-full-v2-secondary-actions">
              <button onClick={generateStrategy} disabled={isOperatorControlLocked()} title={getOperatorLockTitle("GENERATE STRATEGY")}>
                {loading && loadingMode === "generate" ? "GENERATING..." : "> GENERATE STRATEGY <"}
              </button>
            </div>
          </section>
