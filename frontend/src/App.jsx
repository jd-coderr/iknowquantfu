...
`;
  ...
  async function generateStrategy() {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/generate-strategy`, {
        method: "POST",
        headers: {
  ...
  async function optimizeStrategy() {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/optimize-strategy`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
...
<p className="hero-description">
  Connect your EVM-compatible wallet on BNB Smart Chain, generate and optimize trading strategies, and deploy the best-performing system to automatically execute trades based on live market conditions and risk controls.
</p>
